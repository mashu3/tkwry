...
def test_embed_origin_not_root_relative() -> None:
...
def test_embed_origin_root_relative_uses_toplevel_offset() -> None:
    import tkinter as tk
    ...
    try:
        ...
        assert x == frame.winfo_rootx() - root.winfo_rootx()
        assert y == frame.winfo_rooty() - root.winfo_rooty()
    finally:
        root.destroy()
